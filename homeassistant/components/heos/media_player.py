"""Support for media players through HEOS."""
...
class HeosMediaPlayer(MediaPlayerDevice):
    ...
    async def async_clear_playlist(self):
        ...
        return await self._player.clear_queue()
    ...
    async def async_media_previous_track(self):
        ...
        return await self._player.play_previous()

    async def async_media_next_track(self):
        """Send next track command."""
        return await self._player.play_next()
    ...
    async def async_mute_volume(self, mute):
        """Mute the volume."""
        return await self._player.set_mute(mute)

    async def async_set_shuffle(self, shuffle):
        """Enable/disable shuffle mode."""
        return await self._player.set_play_mode(self._player.repeat, shuffle)

    async def async_set_volume_level(self, volume):
        """Set volume level, range 0..1."""
        return await self._player.set_volume(volume * 100)
    ...
    def media_position(self):
        ...
        if not self._player.now_playing_media.duration:
            return None
        return self._player.now_playing_media.current_position / 1000.0
